...
public class LooperExposeView extends FrameLayout {
    ...
    private TextView tvTitle,tvTime,tvName,tvContent;
    ...
    public LooperExposeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTipFrame(context);
        initAnimation();
    }

    public LooperExposeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initTipFrame(context);
        initAnimation();
    }
    private void initTipFrame(Context context) {
        tv_tip_in = LayoutInflater.from(context).inflate(R.layout.layout_looper_personexpose,null);
        tv_tip_out = LayoutInflater.from(context).inflate(R.layout.layout_looper_personexpose,null);
        addView(tv_tip_out);
        addView(tv_tip_in);
    }
...
//            this.bringChildToFront(tv_tip_out);
    ...
    private void updateTip(View tipView) {
        ...
        tvName = tipView.findViewById(R.id.tvName);
        tvTime = tipView.findViewById(R.id.tvTime);
        tvContent = tipView.findViewById(R.id.tvContent);
        final AskLawDetailBean.SafeguardRightInfoBean tip = getNextTip();
        if(null!=tip) {
            tvTitle.setText(tip.getRpTitle());
            tvName.setText(tip.getRpUserName());
            tvContent.setText(tip.getRpContent());
            tvTime.setText(Utils.getTimeTip(tip.getTimeDif(),tip.getIssueStamp()));
        }
    ...
    public void setTipList(CopyOnWriteArrayList<AskLawDetailBean.SafeguardRightInfoBean> tipList) {
    ...
    public interface LoopClickListener{
        void clickLoop(AskLawDetailBean.SafeguardRightInfoBean classicNewsBean);
    }
