...
import com.mahuahudong.res.TextDrawUtils;
...
public class AZSideBarView extends View {
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = typeArray.getColor(R.styleable.AZSideBarView_backgroundColor, Color.parseColor("#ffffff"));
        mStrokeColor = typeArray.getColor(R.styleable.AZSideBarView_strokeColor, Color.parseColor("#ffffff"));
        mTextColor = typeArray.getColor(R.styleable.AZWaveSideBarView_sideTextColor, Color.parseColor("#f14767"));
        mTextSize = typeArray.getDimensionPixelOffset(R.styleable.AZWaveSideBarView_sideTextSize,
        ...
        mHintCircleRadius = typeArray.getDimensionPixelOffset(R.styleable.AZSideBarView_hintCircleRadius,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24,
                        getResources().getDisplayMetrics()));
        mHintCircleColor = typeArray.getColor(R.styleable.AZSideBarView_hintCircleColor, Color.parseColor("#f14767"));
