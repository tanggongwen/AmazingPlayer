...
import com.lbs.apps.library.media.videoplayer.controller.GestureVideoController;
    ...
    public void setPlayerState(int playerState) {
        switch (playerState) {
            case VideoView.PLAYER_NORMAL:
                ...
                mStopFullscreen.setVisibility(View.GONE);
                break;
            case VideoView.PLAYER_FULL_SCREEN:
                ...
                mStopFullscreen.setVisibility(View.VISIBLE);
                if (mShowing) {
...
//                mLoadingProgress.setVisibility(GONE);
            ...
            case VideoView.STATE_PLAYBACK_COMPLETED:
                ...
                mStopFullscreen.setVisibility(mMediaPlayer.isFullScreen() ? View.VISIBLE : View.GONE);
                mBottomProgress.setVisibility(View.GONE);
                mBottomProgress.setProgress(0);
                mBottomProgress.setSecondaryProgress(0);
                mLoadingProgress.setVisibility(View.GONE);
    ...
    protected void doLockUnlock() {
        if (mIsLocked) {
            ...
            show();
            mLockButton.setSelected(false);
            Toast.makeText(getContext(), R.string.video_unlocked, Toast.LENGTH_SHORT).show();
        } else {
            hide();
            mIsLocked = true;
            mIsGestureEnabled = false;
            mLockButton.setSelected(true);
            Toast.makeText(getContext(), R.string.video_locked, Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onBackPressed() {
        if (mIsLocked) {
            show();
            Toast.makeText(getContext(), R.string.video_lock_tip, Toast.LENGTH_SHORT).show();
            return true;
        }
