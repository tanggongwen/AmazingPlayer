package com.mahuahudong.mvvm.http.interceptor.logging;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (subtype != null && (subtype.contains("json")
            ...
            try {
                ...
                if (jsonObject.get("code").equals("401")||jsonObject.get("code").equals("40101")){
                ...
                LogUtils.d("tanggongwen:"+e.toString());
            }
            if (request.url().toString().contains("nburypoints")){

                LogUtils.d("tanggongwen:"+bodyString);
            }
