...
public class BaseViewModel<M extends BaseModel> extends AndroidViewModel implements IBaseViewModel, Consumer<Disposable> {
    ...
    public final class UIChangeLiveData extends SingleLiveEvent {
        ...
        private SingleLiveEvent<String> parentEvent;
        ...
        private SingleLiveEvent<VideoDetailBean.DetailBean.UrlBean> reloadEvent;
        ...
        public SingleLiveEvent<String> getWxClientEvent() {
            return wxClientEvent = createLiveData(wxClientEvent);
        }

        public SingleLiveEvent<String> getParentEvent() {
            return parentEvent = createLiveData(parentEvent);
        }

        public SingleLiveEvent<Integer> getIndicEvent() {
            return indicEvent = createLiveData(indicEvent);
        }
        ...
        public SingleLiveEvent<VideoDetailBean.DetailBean.UrlBean> getReloadEvent(){
