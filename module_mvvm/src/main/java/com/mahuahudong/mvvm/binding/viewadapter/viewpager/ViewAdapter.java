package com.mahuahudong.mvvm.binding.viewadapter.viewpager;
...
public class ViewAdapter {
    @BindingAdapter(value = {"onPageScrolledCommand", "onPageSelectedCommand", "onPageScrollStateChangedCommand","offscreenPageLimit"}, requireAll = false)
