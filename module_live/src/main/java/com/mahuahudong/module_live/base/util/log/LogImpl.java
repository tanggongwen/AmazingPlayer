package com.mahuahudong.module_live.base.util.log;
...
final class LogImpl {
    ...
    private static final String LIVE_LOG_PREFIX = "Live_Log_";
    ...
    public static void o(final int priority, final String tag, final String msg, final Throwable tr) {
        ...
        logger.execute(new Runnable() {
            ...
            public void run() {
                ...
                Log.println(priority, LIVE_LOG_PREFIX + tag, threadId + "/" + msg + '\n' + Log.getStackTraceString(tr));
