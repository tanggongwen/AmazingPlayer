package com.mahuahudong.module_live.entertainment.http;
...
import com.mahuahudong.module_live.base.http.NimHttpClient;
import com.mahuahudong.module_live.base.util.log.LogUtil;
import com.mahuahudong.module_live.config.DemoServers;
...
public class ChatRoomHttpClient {
     ...
     * 主播创建直播间
     */
    public void masterCreateRoom(String account, String ext, boolean isVideoMode, boolean isPortrait, final ChatRoomHttpCallback<EnterRoomParam> callback) {
        ...
        body.append(REQUEST_USER_UID).append("=").append(account).append("&")
                ...
                .append(REQUEST_AV_TYPE).append("=").append(isVideoMode ? KEY_VIDEO : KEY_AUDIO).append("&")
        ...
        NimHttpClient.getInstance().execute(url, headers, bodyString, new NimHttpClient.NimHttpCallback() {
            ...
            public void onResponse(String response, int code, String errorMsg) {
                if (code != 0) {
                    LogUtil.e(TAG, "masterCreateRoom failed : code = " + code + ", errorMsg = " + errorMsg);
                    if (callback != null) {
                ...
                try {
                    ...
                    if (resCode == RESULT_CODE_SUCCESS) {
                        ...
                        LogUtil.e(TAG, "masterCreateRoom failed : code = " + code + ", errorMsg = " + res.getString(RESULT_KEY_ERROR_MSG));
            ...
            public void onResponse(String response, int code, String errorMsg) {
                ...
                try {
                    ...
                    if (resCode == RESULT_CODE_SUCCESS) {
                        ...
                        if (msg != null) {
                            JSONObject live = msg.getJSONObject(RESULT_KEY_LIVE);
                            url1 = live.getString(RESULT_KEY_PULL_URL);
                        ...
                        enterRoomParam.setPullUrl(url1);
