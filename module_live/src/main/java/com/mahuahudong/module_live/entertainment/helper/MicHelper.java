package com.mahuahudong.module_live.entertainment.helper;
...
public class MicHelper {
    ...
    public void joinAVRoom(final String meetingName, boolean isVideo, final ChannelCallback callback) {
    ...
    public void joinAVRoom(final String meetingName, boolean isVideo, final AVChatCallback<AVChatData> callback) {
