...
import com.mahuahudong.module_live.entertainment.helper.GiftAnimation;
import com.mahuahudong.module_live.entertainment.module.ChatRoomMsgListPanel;
import com.mahuahudong.module_live.entertainment.module.ConnectedAttachment;
import com.mahuahudong.module_live.entertainment.module.DisconnectAttachment;
import com.mahuahudong.module_live.entertainment.module.GiftAttachment;
import com.mahuahudong.module_live.entertainment.module.LikeAttachment;
import com.mahuahudong.module_live.entertainment.module.UserJoinAttachment;
import com.mahuahudong.module_live.entertainment.module.UserLeaveAttachment;
import com.mahuahudong.module_live.im.session.Container;
import com.mahuahudong.module_live.im.session.ModuleProxy;
import com.mahuahudong.module_live.im.session.actions.BaseAction;
import com.mahuahudong.module_live.im.session.emoji.MoonUtil;
import com.mahuahudong.module_live.im.session.input.InputConfig;
import com.mahuahudong.module_live.im.session.input.InputPanel;
...
public abstract class LivePlayerBaseActivity extends TActivity implements ModuleProxy {
    ...
    Observer<ChatRoomStatusChangeData> chatRoomOnlineStatusObserver = new Observer<ChatRoomStatusChangeData>() {
        @Override
    ...
    // 用户状态变化
    Observer<StatusCode> loginStatusObserver = new Observer<StatusCode>() {
        @Override
    ...
    Observer<ChatRoomKickOutEvent> chatRoomKickOutObserver = new Observer<ChatRoomKickOutEvent>() {
        @Override
        public void onEvent(ChatRoomKickOutEvent chatRoomKickOutEvent) {
            Toast.makeText(LivePlayerBaseActivity.this, "被踢出聊天室，原因:" + chatRoomKickOutEvent.getReason(), Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(LivePlayerBaseActivity.this.getApplicationContext(), IdentifyActivity.class);
    ...
    private void findInteractionViews() {
        ...
        for (int i = 0; i < interactionGroupView.length; i++) {
            ...
            interactionView.connectionCloseConfirm.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    LivePlayerBaseActivity.this.doCloseInteraction(interactionView);
                    LivePlayerBaseActivity.this.doCloseInteractionView(index);
                }
            });
