...
import com.lbs.apps.library.media.R;

import com.lbs.apps.library.media.exo.ExoMediaPlayerFactory;
import com.lbs.apps.library.media.ijk.IjkPlayerFactory;
import com.lbs.apps.library.media.videoplayer.controller.BaseVideoController;
import com.lbs.apps.library.media.videoplayer.controller.MediaPlayerControl;
import com.lbs.apps.library.media.videoplayer.listener.OnVideoViewStateChangeListener;
import com.lbs.apps.library.media.videoplayer.listener.PlayerEventListener;
import com.lbs.apps.library.media.videoplayer.util.PlayerUtils;
import com.lbs.apps.library.media.videoplayer.widget.IRenderView;
import com.lbs.apps.library.media.videoplayer.widget.SurfaceRenderView;
import com.lbs.apps.library.media.videoplayer.widget.TextureRenderView;
...
public class VideoView extends FrameLayout implements MediaPlayerControl, PlayerEventListener,
    ...
    public VideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //默认使用系统的ijkPlayerFactory进行解码
        mPlayerFactory = config.mPlayerFactory == null ? ExoMediaPlayerFactory.create(context) : config.mPlayerFactory;
